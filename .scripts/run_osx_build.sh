...
validate_recipe_outputs "google-cloud-bigquery-storage-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="google-cloud-bigquery-storage-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi